...
80102486:	81 fb a8 74 11 80    	cmp    $0x801174a8,%ebx
...
8010305b:	68 a8 74 11 80       	push   $0x801174a8
...
801037af:	90                   	nop
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
801037b0:	81 c3 fc 00 00 00    	add    $0xfc,%ebx
801037b6:	81 fb 54 6c 11 80    	cmp    $0x80116c54,%ebx
...
80103807:	89 53 18             	mov    %edx,0x18(%ebx)
  *(uint*)sp = (uint)trapret;
8010380a:	c7 40 14 0b 59 10 80 	movl   $0x8010590b,0x14(%eax)
  p->context = (struct context*)sp;
...
801039b7:	e8 14 35 00 00       	call   80106ed0 <setupkvm>
801039bc:	89 43 04             	mov    %eax,0x4(%ebx)
801039bf:	85 c0                	test   %eax,%eax
801039c1:	0f 84 d0 00 00 00    	je     80103a97 <userinit+0xf7>
...
801039f2:	ba 1b 00 00 00       	mov    $0x1b,%edx
  memset(p->syscall_counts, 0, sizeof(int) * 32);
...
80103a37:	c7 40 38 00 00 00 00 	movl   $0x0,0x38(%eax)
  memset(p->syscall_counts, 0, sizeof(int) * 32);
80103a3e:	8d 43 7c             	lea    0x7c(%ebx),%eax
80103a41:	68 80 00 00 00       	push   $0x80
80103a46:	6a 00                	push   $0x0
80103a48:	50                   	push   %eax
80103a49:	e8 82 0c 00 00       	call   801046d0 <memset>
  safestrcpy(p->name, "initcode", sizeof(p->name));
80103a4e:	83 c4 0c             	add    $0xc,%esp
80103a51:	8d 43 6c             	lea    0x6c(%ebx),%eax
80103a54:	6a 10                	push   $0x10
80103a56:	68 d0 76 10 80       	push   $0x801076d0
80103a5b:	50                   	push   %eax
80103a5c:	e8 2f 0e 00 00       	call   80104890 <safestrcpy>
  p->cwd = namei("/");
80103a61:	c7 04 24 d9 76 10 80 	movl   $0x801076d9,(%esp)
80103a68:	e8 c3 e5 ff ff       	call   80102030 <namei>
80103a6d:	89 43 68             	mov    %eax,0x68(%ebx)
  acquire(&ptable.lock);
80103a70:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
80103a77:	e8 44 0b 00 00       	call   801045c0 <acquire>
  p->state = RUNNABLE;
80103a7c:	c7 43 0c 03 00 00 00 	movl   $0x3,0xc(%ebx)
  release(&ptable.lock);
80103a83:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
80103a8a:	e8 f1 0b 00 00       	call   80104680 <release>
}
...
80103a9a:	68 b7 76 10 80       	push   $0x801076b7
80103a9f:	e8 ec c8 ff ff       	call   80100390 <panic>
...
80103abc:	e8 ff 09 00 00       	call   801044c0 <pushcli>
  c = mycpu();
80103ac1:	e8 1a fe ff ff       	call   801038e0 <mycpu>
  p = c->proc;
...
80103adf:	e8 ac 2f 00 00       	call   80106a90 <switchuvm>
  return 0;
...
80103afa:	e8 f1 31 00 00       	call   80106cf0 <allocuvm>
...
80103b1a:	e8 01 33 00 00       	call   80106e20 <deallocuvm>
...
80103b3d:	e8 7e 09 00 00       	call   801044c0 <pushcli>
  c = mycpu();
80103b42:	e8 99 fd ff ff       	call   801038e0 <mycpu>
  p = c->proc;
...
80103c3a:	eb ef                	jmp    80103c2b <fork+0xfb>
    kfree(np->kstack);
...
80103c60:	eb c9                	jmp    80103c2b <fork+0xfb>
...
80103cc0:	e8 cb 2d 00 00       	call   80106a90 <switchuvm>
...
80103cd2:	e8 1c 0c 00 00       	call   801048f3 <swtch>
      switchkvm();
80103cd7:	e8 94 2d 00 00       	call   80106a70 <switchkvm>
      c->proc = 0;
80103cdc:	83 c4 10             	add    $0x10,%esp
80103cdf:	c7 86 ac 00 00 00 00 	movl   $0x0,0xac(%esi)
80103ce6:	00 00 00 
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103ce9:	81 c3 fc 00 00 00    	add    $0xfc,%ebx
80103cef:	81 fb 54 6c 11 80    	cmp    $0x80116c54,%ebx
...
80103e65:	3d 54 6c 11 80       	cmp    $0x80116c54,%eax
...
80103e77:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103e7e:	05 fc 00 00 00       	add    $0xfc,%eax
80103e83:	3d 54 6c 11 80       	cmp    $0x80116c54,%eax
...
80103ea0:	81 c2 fc 00 00 00    	add    $0xfc,%edx
80103ea6:	81 fa 54 6c 11 80    	cmp    $0x80116c54,%edx
...
80103ec7:	90                   	nop
80103ec8:	05 fc 00 00 00       	add    $0xfc,%eax
80103ecd:	3d 54 6c 11 80       	cmp    $0x80116c54,%eax
...
80103ef7:	68 28 77 10 80       	push   $0x80107728
80103efc:	e8 8f c4 ff ff       	call   80100390 <panic>
    panic("init exiting");
80103f01:	83 ec 0c             	sub    $0xc,%esp
80103f04:	68 1b 77 10 80       	push   $0x8010771b
...
80104009:	68 3a 77 10 80       	push   $0x8010773a
8010400e:	e8 7d c3 ff ff       	call   80100390 <panic>
    panic("sleep");
80104013:	83 ec 0c             	sub    $0xc,%esp
80104016:	68 34 77 10 80       	push   $0x80107734
...
80104060:	81 c3 fc 00 00 00    	add    $0xfc,%ebx
80104066:	81 fb 54 6c 11 80    	cmp    $0x80116c54,%ebx
...
80104077:	74 37                	je     801040b0 <wait+0x90>
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104079:	81 c3 fc 00 00 00    	add    $0xfc,%ebx
      havekids = 1;
8010407f:	b8 01 00 00 00       	mov    $0x1,%eax
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104084:	81 fb 54 6c 11 80    	cmp    $0x80116c54,%ebx
...
801040c2:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
        freevm(p->pgdir);
801040c9:	e8 82 2d 00 00       	call   80106e50 <freevm>
        release(&ptable.lock);
...
80104148:	05 fc 00 00 00       	add    $0xfc,%eax
8010414d:	3d 54 6c 11 80       	cmp    $0x80116c54,%eax
...
8010415f:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80104166:	05 fc 00 00 00       	add    $0xfc,%eax
8010416b:	3d 54 6c 11 80       	cmp    $0x80116c54,%eax
...
801041b8:	05 fc 00 00 00       	add    $0xfc,%eax
801041bd:	3d 54 6c 11 80       	cmp    $0x80116c54,%eax
...
80104243:	68 bb 7a 10 80       	push   $0x80107abb
80104248:	e8 63 c4 ff ff       	call   801006b0 <cprintf>
8010424d:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104250:	81 c3 fc 00 00 00    	add    $0xfc,%ebx
80104256:	81 fb c0 6c 11 80    	cmp    $0x80116cc0,%ebx
...
80104267:	74 e7                	je     80104250 <procdump+0x30>
      state = "???";
80104269:	ba 4b 77 10 80       	mov    $0x8010774b,%edx
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
8010426e:	83 f8 05             	cmp    $0x5,%eax
80104271:	77 11                	ja     80104284 <procdump+0x64>
80104273:	8b 14 85 ac 77 10 80 	mov    -0x7fef8854(,%eax,4),%edx
      state = "???";
8010427a:	b8 4b 77 10 80       	mov    $0x8010774b,%eax
...
80104289:	68 4f 77 10 80       	push   $0x8010774f
...
801042d1:	68 a1 71 10 80       	push   $0x801071a1
...
8010430e:	68 c4 77 10 80       	push   $0x801077c4
...
80104555:	68 cf 77 10 80       	push   $0x801077cf
8010455a:	e8 31 be ff ff       	call   80100390 <panic>
    panic("popcli");
8010455f:	83 ec 0c             	sub    $0xc,%esp
80104562:	68 e6 77 10 80       	push   $0x801077e6
...
80104667:	68 ed 77 10 80       	push   $0x801077ed
...
801046c0:	68 f5 77 10 80       	push   $0x801077f5
...
80104ab3:	8b 70 1c             	mov    0x1c(%eax),%esi
  if(num > 0 && num < NELEM(syscalls) && syscalls[num]) {
80104ab6:	8d 46 ff             	lea    -0x1(%esi),%eax
80104ab9:	83 f8 15             	cmp    $0x15,%eax
80104abc:	77 22                	ja     80104ae0 <syscall+0x40>
80104abe:	8b 04 b5 20 78 10 80 	mov    -0x7fef87e0(,%esi,4),%eax
80104ac5:	85 c0                	test   %eax,%eax
80104ac7:	74 17                	je     80104ae0 <syscall+0x40>
    curproc->tf->eax = syscalls[num]();
80104ac9:	ff d0                	call   *%eax
80104acb:	8b 53 18             	mov    0x18(%ebx),%edx
80104ace:	89 42 1c             	mov    %eax,0x1c(%edx)
    curproc->syscall_counts[num] += 1;
80104ad1:	83 44 b3 7c 01       	addl   $0x1,0x7c(%ebx,%esi,4)
  } else {
...
80104add:	8d 76 00             	lea    0x0(%esi),%esi
            curproc->pid, curproc->name, num);
80104ae0:	8d 43 6c             	lea    0x6c(%ebx),%eax
    cprintf("%d %s: unknown sys call %d\n",
80104ae3:	56                   	push   %esi
80104ae4:	50                   	push   %eax
80104ae5:	ff 73 10             	pushl  0x10(%ebx)
80104ae8:	68 fd 77 10 80       	push   $0x801077fd
...
80104c44:	68 98 78 10 80       	push   $0x80107898
...
80104c5c:	68 97 78 10 80       	push   $0x80107897
...
80104c71:	68 8b 78 10 80       	push   $0x8010788b
...
80104c8f:	68 9a 78 10 80       	push   $0x8010789a
80104c94:	e8 f7 b6 ff ff       	call   80100390 <panic>
    panic("create: ialloc");
80104c99:	83 ec 0c             	sub    $0xc,%esp
80104c9c:	68 7c 78 10 80       	push   $0x8010787c
...
8010508d:	58                   	pop    %eax
8010508e:	5a                   	pop    %edx
8010508f:	68 98 78 10 80       	push   $0x80107898
...
801050a8:	68 97 78 10 80       	push   $0x80107897
...
80105717:	83 ec 08             	sub    $0x8,%esp
  exit();
8010571a:	e8 b1 e6 ff ff       	call   80103dd0 <exit>
...
80105730:	f3 0f 1e fb          	endbr32 
  return wait();
80105734:	e9 e7 e8 ff ff       	jmp    80104020 <wait>
...
80105762:	e8 29 ea ff ff       	call   80104190 <kill>
...
80105814:	68 60 6c 11 80       	push   $0x80116c60
80105819:	e8 a2 ed ff ff       	call   801045c0 <acquire>
  ticks0 = ticks;
  while(ticks - ticks0 < n){
8010581e:	8b 55 f4             	mov    -0xc(%ebp),%edx
  ticks0 = ticks;
80105821:	8b 1d a0 74 11 80    	mov    0x801174a0,%ebx
  while(ticks - ticks0 < n){
...
80105833:	68 60 6c 11 80       	push   $0x80116c60
80105838:	68 a0 74 11 80       	push   $0x801174a0
8010583d:	e8 1e e7 ff ff       	call   80103f60 <sleep>
  while(ticks - ticks0 < n){
80105842:	a1 a0 74 11 80       	mov    0x801174a0,%eax
...
80105860:	68 60 6c 11 80       	push   $0x80116c60
...
80105883:	68 60 6c 11 80       	push   $0x80116c60
...
801058a8:	83 ec 10             	sub    $0x10,%esp
  ...
  acquire(&tickslock);
801058ab:	68 60 6c 11 80       	push   $0x80116c60
801058b0:	e8 0b ed ff ff       	call   801045c0 <acquire>
  xticks = ticks;
801058b5:	8b 1d a0 74 11 80    	mov    0x801174a0,%ebx
  release(&tickslock);
801058bb:	c7 04 24 60 6c 11 80 	movl   $0x80116c60,(%esp)
...
801058e0:	e8 cb f0 ff ff       	call   801049b0 <argint>
  return myproc()->syscall_counts[n];
801058e5:	e8 86 e0 ff ff       	call   80103970 <myproc>
801058ea:	8b 55 f4             	mov    -0xc(%ebp),%edx
801058ed:	8b 44 90 7c          	mov    0x7c(%eax,%edx,4),%eax
}
801058f1:	c9                   	leave  
801058f2:	c3                   	ret    
...
801058f4:	06                   	push   %es
  pushl %fs
801058f5:	0f a0                	push   %fs
  pushl %gs
801058f7:	0f a8                	push   %gs
  pushal
801058f9:	60                   	pusha  
  
  # Set up data segments.
  movw $(SEG_KDATA<<3), %ax
801058fa:	66 b8 10 00          	mov    $0x10,%ax
  movw %ax, %ds
801058fe:	8e d8                	mov    %eax,%ds
  movw %ax, %es
80105900:	8e c0                	mov    %eax,%es

  # Call trap(tf), where tf=%esp
  pushl %esp
80105902:	54                   	push   %esp
  call trap
80105903:	e8 c8 00 00 00       	call   801059d0 <trap>
  addl $4, %esp
80105908:	83 c4 04             	add    $0x4,%esp
...
8010590b:	61                   	popa   
  popl %gs
8010590c:	0f a9                	pop    %gs
  popl %fs
8010590e:	0f a1                	pop    %fs
  popl %es
80105910:	07                   	pop    %es
  popl %ds
80105911:	1f                   	pop    %ds
  addl $0x8, %esp  # trapno and errcode
80105912:	83 c4 08             	add    $0x8,%esp
  iret
80105915:	cf                   	iret   
...
80105937:	c7 04 c5 a2 6c 11 80 	movl   $0x8e000008,-0x7fee935e(,%eax,8)
8010593e:	08 00 00 8e 
80105942:	66 89 14 c5 a0 6c 11 	mov    %dx,-0x7fee9360(,%eax,8)
80105949:	80 
8010594a:	c1 ea 10             	shr    $0x10,%edx
8010594d:	66 89 14 c5 a6 6c 11 	mov    %dx,-0x7fee935a(,%eax,8)
80105954:	80 
  for(i = 0; i < 256; i++)
...
80105967:	c7 05 a2 6e 11 80 08 	movl   $0xef000008,0x80116ea2
8010596e:	00 00 ef 
  initlock(&tickslock, "time");
80105971:	68 dd 78 10 80       	push   $0x801078dd
80105976:	68 60 6c 11 80       	push   $0x80116c60
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
8010597b:	66 a3 a0 6e 11 80    	mov    %ax,0x80116ea0
80105981:	c1 e8 10             	shr    $0x10,%eax
80105984:	66 a3 a6 6e 11 80    	mov    %ax,0x80116ea6
  initlock(&tickslock, "time");
8010598a:	e8 b1 ea ff ff       	call   80104440 <initlock>
}
...
801059af:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
801059b3:	b8 a0 6c 11 80       	mov    $0x80116ca0,%eax
...
801059f4:	3e ff 24 85 84 79 10 	notrack jmp *-0x7fef867c(,%eax,4)
801059fb:	80 
    lapiceoi();
    break;
...
80105a51:	68 40 79 10 80       	push   $0x80107940
...
80105af7:	68 60 6c 11 80       	push   $0x80116c60
80105afc:	e8 bf ea ff ff       	call   801045c0 <acquire>
      wakeup(&ticks);
80105b01:	c7 04 24 a0 74 11 80 	movl   $0x801174a0,(%esp)
      ticks++;
80105b08:	83 05 a0 74 11 80 01 	addl   $0x1,0x801174a0
      wakeup(&ticks);
80105b0f:	e8 0c e6 ff ff       	call   80104120 <wakeup>
      release(&tickslock);
80105b14:	c7 04 24 60 6c 11 80 	movl   $0x80116c60,(%esp)
80105b1b:	e8 60 eb ff ff       	call   80104680 <release>
...
80105b6c:	68 e8 78 10 80       	push   $0x801078e8
...
80105b94:	0f 85 0e ff ff ff    	jne    80105aa8 <trap+0xd8>
    yield();
80105b9a:	e8 71 e3 ff ff       	call   80103f10 <yield>
...
80105bb9:	89 58 18             	mov    %ebx,0x18(%eax)
    syscall();
80105bbc:	e8 df ee ff ff       	call   80104aa0 <syscall>
    if(myproc()->killed)
...
80105bd7:	5d                   	pop    %ebp
      exit();
80105bd8:	e9 f3 e1 ff ff       	jmp    80103dd0 <exit>
80105bdd:	8d 76 00             	lea    0x0(%esi),%esi
    exit();
80105be0:	e8 eb e1 ff ff       	call   80103dd0 <exit>
80105be5:	e9 a6 fe ff ff       	jmp    80105a90 <trap+0xc0>
80105bea:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      exit();
80105bf0:	e8 db e1 ff ff       	call   80103dd0 <exit>
...
80105c08:	68 0c 79 10 80       	push   $0x8010790c
80105c0d:	e8 9e aa ff ff       	call   801006b0 <cprintf>
      panic("trap");
80105c12:	83 c4 14             	add    $0x14,%esp
80105c15:	68 e2 78 10 80       	push   $0x801078e2
...
80105d13:	be 76 00 00 00       	mov    $0x76,%esi
  for(p="xv6...\n"; *p; p++)
80105d18:	bb 04 7a 10 80       	mov    $0x80107a04,%ebx
  ioapicenable(IRQ_COM1, 0);
...
80105dab:	6a 00                	push   $0x0
  jmp alltraps
80105dad:	e9 41 fb ff ff       	jmp    801058f3 <alltraps>
...
80105db4:	6a 01                	push   $0x1
  jmp alltraps
80105db6:	e9 38 fb ff ff       	jmp    801058f3 <alltraps>
...
80105dbd:	6a 02                	push   $0x2
  jmp alltraps
80105dbf:	e9 2f fb ff ff       	jmp    801058f3 <alltraps>
...
80105dc6:	6a 03                	push   $0x3
  jmp alltraps
80105dc8:	e9 26 fb ff ff       	jmp    801058f3 <alltraps>
...
80105dcf:	6a 04                	push   $0x4
  jmp alltraps
80105dd1:	e9 1d fb ff ff       	jmp    801058f3 <alltraps>
...
80105dd8:	6a 05                	push   $0x5
  jmp alltraps
80105dda:	e9 14 fb ff ff       	jmp    801058f3 <alltraps>
...
80105de1:	6a 06                	push   $0x6
  jmp alltraps
80105de3:	e9 0b fb ff ff       	jmp    801058f3 <alltraps>
...
80105dea:	6a 07                	push   $0x7
  jmp alltraps
80105dec:	e9 02 fb ff ff       	jmp    801058f3 <alltraps>
...
80105df1:	6a 08                	push   $0x8
  jmp alltraps
80105df3:	e9 fb fa ff ff       	jmp    801058f3 <alltraps>
...
80105dfa:	6a 09                	push   $0x9
  jmp alltraps
80105dfc:	e9 f2 fa ff ff       	jmp    801058f3 <alltraps>
...
80105e01:	6a 0a                	push   $0xa
  jmp alltraps
80105e03:	e9 eb fa ff ff       	jmp    801058f3 <alltraps>
...
80105e08:	6a 0b                	push   $0xb
  jmp alltraps
80105e0a:	e9 e4 fa ff ff       	jmp    801058f3 <alltraps>
...
80105e0f:	6a 0c                	push   $0xc
  jmp alltraps
80105e11:	e9 dd fa ff ff       	jmp    801058f3 <alltraps>
...
80105e16:	6a 0d                	push   $0xd
  jmp alltraps
80105e18:	e9 d6 fa ff ff       	jmp    801058f3 <alltraps>
...
80105e1d:	6a 0e                	push   $0xe
  jmp alltraps
80105e1f:	e9 cf fa ff ff       	jmp    801058f3 <alltraps>
...
80105e26:	6a 0f                	push   $0xf
  jmp alltraps
80105e28:	e9 c6 fa ff ff       	jmp    801058f3 <alltraps>
...
80105e2f:	6a 10                	push   $0x10
  jmp alltraps
80105e31:	e9 bd fa ff ff       	jmp    801058f3 <alltraps>
...
80105e36:	6a 11                	push   $0x11
  jmp alltraps
80105e38:	e9 b6 fa ff ff       	jmp    801058f3 <alltraps>
...
80105e3f:	6a 12                	push   $0x12
  jmp alltraps
80105e41:	e9 ad fa ff ff       	jmp    801058f3 <alltraps>
...
80105e48:	6a 13                	push   $0x13
  jmp alltraps
80105e4a:	e9 a4 fa ff ff       	jmp    801058f3 <alltraps>
...
80105e51:	6a 14                	push   $0x14
  jmp alltraps
80105e53:	e9 9b fa ff ff       	jmp    801058f3 <alltraps>
...
80105e5a:	6a 15                	push   $0x15
  jmp alltraps
80105e5c:	e9 92 fa ff ff       	jmp    801058f3 <alltraps>
...
80105e63:	6a 16                	push   $0x16
  jmp alltraps
80105e65:	e9 89 fa ff ff       	jmp    801058f3 <alltraps>
...
80105e6c:	6a 17                	push   $0x17
  jmp alltraps
80105e6e:	e9 80 fa ff ff       	jmp    801058f3 <alltraps>
...
80105e75:	6a 18                	push   $0x18
  jmp alltraps
80105e77:	e9 77 fa ff ff       	jmp    801058f3 <alltraps>
...
80105e7e:	6a 19                	push   $0x19
  jmp alltraps
80105e80:	e9 6e fa ff ff       	jmp    801058f3 <alltraps>
...
80105e87:	6a 1a                	push   $0x1a
  jmp alltraps
80105e89:	e9 65 fa ff ff       	jmp    801058f3 <alltraps>
...
80105e90:	6a 1b                	push   $0x1b
  jmp alltraps
80105e92:	e9 5c fa ff ff       	jmp    801058f3 <alltraps>
...
80105e99:	6a 1c                	push   $0x1c
  jmp alltraps
80105e9b:	e9 53 fa ff ff       	jmp    801058f3 <alltraps>
...
80105ea2:	6a 1d                	push   $0x1d
  jmp alltraps
80105ea4:	e9 4a fa ff ff       	jmp    801058f3 <alltraps>
...
80105eab:	6a 1e                	push   $0x1e
  jmp alltraps
80105ead:	e9 41 fa ff ff       	jmp    801058f3 <alltraps>
...
80105eb4:	6a 1f                	push   $0x1f
  jmp alltraps
80105eb6:	e9 38 fa ff ff       	jmp    801058f3 <alltraps>
...
80105ebd:	6a 20                	push   $0x20
  jmp alltraps
80105ebf:	e9 2f fa ff ff       	jmp    801058f3 <alltraps>
...
80105ec6:	6a 21                	push   $0x21
  jmp alltraps
80105ec8:	e9 26 fa ff ff       	jmp    801058f3 <alltraps>
...
80105ecf:	6a 22                	push   $0x22
  jmp alltraps
80105ed1:	e9 1d fa ff ff       	jmp    801058f3 <alltraps>
...
80105ed8:	6a 23                	push   $0x23
  jmp alltraps
80105eda:	e9 14 fa ff ff       	jmp    801058f3 <alltraps>
...
80105ee1:	6a 24                	push   $0x24
  jmp alltraps
80105ee3:	e9 0b fa ff ff       	jmp    801058f3 <alltraps>
...
80105eea:	6a 25                	push   $0x25
  jmp alltraps
80105eec:	e9 02 fa ff ff       	jmp    801058f3 <alltraps>
...
80105ef3:	6a 26                	push   $0x26
  jmp alltraps
80105ef5:	e9 f9 f9 ff ff       	jmp    801058f3 <alltraps>
...
80105efc:	6a 27                	push   $0x27
  jmp alltraps
80105efe:	e9 f0 f9 ff ff       	jmp    801058f3 <alltraps>
...
80105f05:	6a 28                	push   $0x28
  jmp alltraps
80105f07:	e9 e7 f9 ff ff       	jmp    801058f3 <alltraps>
...
80105f0e:	6a 29                	push   $0x29
  jmp alltraps
80105f10:	e9 de f9 ff ff       	jmp    801058f3 <alltraps>
...
80105f17:	6a 2a                	push   $0x2a
  jmp alltraps
80105f19:	e9 d5 f9 ff ff       	jmp    801058f3 <alltraps>
...
80105f20:	6a 2b                	push   $0x2b
  jmp alltraps
80105f22:	e9 cc f9 ff ff       	jmp    801058f3 <alltraps>
...
80105f29:	6a 2c                	push   $0x2c
  jmp alltraps
80105f2b:	e9 c3 f9 ff ff       	jmp    801058f3 <alltraps>
...
80105f32:	6a 2d                	push   $0x2d
  jmp alltraps
80105f34:	e9 ba f9 ff ff       	jmp    801058f3 <alltraps>
...
80105f3b:	6a 2e                	push   $0x2e
  jmp alltraps
80105f3d:	e9 b1 f9 ff ff       	jmp    801058f3 <alltraps>
...
80105f44:	6a 2f                	push   $0x2f
  jmp alltraps
80105f46:	e9 a8 f9 ff ff       	jmp    801058f3 <alltraps>
...
80105f4d:	6a 30                	push   $0x30
  jmp alltraps
80105f4f:	e9 9f f9 ff ff       	jmp    801058f3 <alltraps>
...
80105f56:	6a 31                	push   $0x31
  jmp alltraps
80105f58:	e9 96 f9 ff ff       	jmp    801058f3 <alltraps>
...
80105f5f:	6a 32                	push   $0x32
  jmp alltraps
80105f61:	e9 8d f9 ff ff       	jmp    801058f3 <alltraps>
...
80105f68:	6a 33                	push   $0x33
  jmp alltraps
80105f6a:	e9 84 f9 ff ff       	jmp    801058f3 <alltraps>
...
80105f71:	6a 34                	push   $0x34
  jmp alltraps
80105f73:	e9 7b f9 ff ff       	jmp    801058f3 <alltraps>
...
80105f7a:	6a 35                	push   $0x35
  jmp alltraps
80105f7c:	e9 72 f9 ff ff       	jmp    801058f3 <alltraps>
...
80105f83:	6a 36                	push   $0x36
  jmp alltraps
80105f85:	e9 69 f9 ff ff       	jmp    801058f3 <alltraps>
...
80105f8c:	6a 37                	push   $0x37
  jmp alltraps
80105f8e:	e9 60 f9 ff ff       	jmp    801058f3 <alltraps>
...
80105f95:	6a 38                	push   $0x38
  jmp alltraps
80105f97:	e9 57 f9 ff ff       	jmp    801058f3 <alltraps>
...
80105f9e:	6a 39                	push   $0x39
  jmp alltraps
80105fa0:	e9 4e f9 ff ff       	jmp    801058f3 <alltraps>
...
80105fa7:	6a 3a                	push   $0x3a
  jmp alltraps
80105fa9:	e9 45 f9 ff ff       	jmp    801058f3 <alltraps>
...
80105fb0:	6a 3b                	push   $0x3b
  jmp alltraps
80105fb2:	e9 3c f9 ff ff       	jmp    801058f3 <alltraps>
...
80105fb9:	6a 3c                	push   $0x3c
  jmp alltraps
80105fbb:	e9 33 f9 ff ff       	jmp    801058f3 <alltraps>
...
80105fc2:	6a 3d                	push   $0x3d
  jmp alltraps
80105fc4:	e9 2a f9 ff ff       	jmp    801058f3 <alltraps>
...
80105fcb:	6a 3e                	push   $0x3e
  jmp alltraps
80105fcd:	e9 21 f9 ff ff       	jmp    801058f3 <alltraps>
...
80105fd4:	6a 3f                	push   $0x3f
  jmp alltraps
80105fd6:	e9 18 f9 ff ff       	jmp    801058f3 <alltraps>
...
80105fdd:	6a 40                	push   $0x40
  jmp alltraps
80105fdf:	e9 0f f9 ff ff       	jmp    801058f3 <alltraps>
...
80105fe6:	6a 41                	push   $0x41
  jmp alltraps
80105fe8:	e9 06 f9 ff ff       	jmp    801058f3 <alltraps>
...
80105fef:	6a 42                	push   $0x42
  jmp alltraps
80105ff1:	e9 fd f8 ff ff       	jmp    801058f3 <alltraps>
...
80105ff8:	6a 43                	push   $0x43
  jmp alltraps
80105ffa:	e9 f4 f8 ff ff       	jmp    801058f3 <alltraps>
...
80106001:	6a 44                	push   $0x44
  jmp alltraps
80106003:	e9 eb f8 ff ff       	jmp    801058f3 <alltraps>
...
8010600a:	6a 45                	push   $0x45
  jmp alltraps
8010600c:	e9 e2 f8 ff ff       	jmp    801058f3 <alltraps>
...
80106013:	6a 46                	push   $0x46
  jmp alltraps
80106015:	e9 d9 f8 ff ff       	jmp    801058f3 <alltraps>
...
8010601c:	6a 47                	push   $0x47
  jmp alltraps
8010601e:	e9 d0 f8 ff ff       	jmp    801058f3 <alltraps>
...
80106025:	6a 48                	push   $0x48
  jmp alltraps
80106027:	e9 c7 f8 ff ff       	jmp    801058f3 <alltraps>
...
8010602e:	6a 49                	push   $0x49
  jmp alltraps
80106030:	e9 be f8 ff ff       	jmp    801058f3 <alltraps>
...
80106037:	6a 4a                	push   $0x4a
  jmp alltraps
80106039:	e9 b5 f8 ff ff       	jmp    801058f3 <alltraps>
...
80106040:	6a 4b                	push   $0x4b
  jmp alltraps
80106042:	e9 ac f8 ff ff       	jmp    801058f3 <alltraps>
...
80106049:	6a 4c                	push   $0x4c
  jmp alltraps
8010604b:	e9 a3 f8 ff ff       	jmp    801058f3 <alltraps>
...
80106052:	6a 4d                	push   $0x4d
  jmp alltraps
80106054:	e9 9a f8 ff ff       	jmp    801058f3 <alltraps>
...
8010605b:	6a 4e                	push   $0x4e
  jmp alltraps
8010605d:	e9 91 f8 ff ff       	jmp    801058f3 <alltraps>
...
80106064:	6a 4f                	push   $0x4f
  jmp alltraps
80106066:	e9 88 f8 ff ff       	jmp    801058f3 <alltraps>
...
8010606d:	6a 50                	push   $0x50
  jmp alltraps
8010606f:	e9 7f f8 ff ff       	jmp    801058f3 <alltraps>
...
80106076:	6a 51                	push   $0x51
  jmp alltraps
80106078:	e9 76 f8 ff ff       	jmp    801058f3 <alltraps>
...
8010607f:	6a 52                	push   $0x52
  jmp alltraps
80106081:	e9 6d f8 ff ff       	jmp    801058f3 <alltraps>
...
80106088:	6a 53                	push   $0x53
  jmp alltraps
8010608a:	e9 64 f8 ff ff       	jmp    801058f3 <alltraps>
...
80106091:	6a 54                	push   $0x54
  jmp alltraps
80106093:	e9 5b f8 ff ff       	jmp    801058f3 <alltraps>
...
8010609a:	6a 55                	push   $0x55
  jmp alltraps
8010609c:	e9 52 f8 ff ff       	jmp    801058f3 <alltraps>
...
801060a3:	6a 56                	push   $0x56
  jmp alltraps
801060a5:	e9 49 f8 ff ff       	jmp    801058f3 <alltraps>
...
801060ac:	6a 57                	push   $0x57
  jmp alltraps
801060ae:	e9 40 f8 ff ff       	jmp    801058f3 <alltraps>
...
801060b5:	6a 58                	push   $0x58
  jmp alltraps
801060b7:	e9 37 f8 ff ff       	jmp    801058f3 <alltraps>
...
801060be:	6a 59                	push   $0x59
  jmp alltraps
801060c0:	e9 2e f8 ff ff       	jmp    801058f3 <alltraps>
...
801060c7:	6a 5a                	push   $0x5a
  jmp alltraps
801060c9:	e9 25 f8 ff ff       	jmp    801058f3 <alltraps>
...
801060d0:	6a 5b                	push   $0x5b
  jmp alltraps
801060d2:	e9 1c f8 ff ff       	jmp    801058f3 <alltraps>
...
801060d9:	6a 5c                	push   $0x5c
  jmp alltraps
801060db:	e9 13 f8 ff ff       	jmp    801058f3 <alltraps>
...
801060e2:	6a 5d                	push   $0x5d
  jmp alltraps
801060e4:	e9 0a f8 ff ff       	jmp    801058f3 <alltraps>
...
801060eb:	6a 5e                	push   $0x5e
  jmp alltraps
801060ed:	e9 01 f8 ff ff       	jmp    801058f3 <alltraps>
...
801060f4:	6a 5f                	push   $0x5f
  jmp alltraps
801060f6:	e9 f8 f7 ff ff       	jmp    801058f3 <alltraps>
...
801060fd:	6a 60                	push   $0x60
  jmp alltraps
801060ff:	e9 ef f7 ff ff       	jmp    801058f3 <alltraps>
...
80106106:	6a 61                	push   $0x61
  jmp alltraps
80106108:	e9 e6 f7 ff ff       	jmp    801058f3 <alltraps>
...
8010610f:	6a 62                	push   $0x62
  jmp alltraps
80106111:	e9 dd f7 ff ff       	jmp    801058f3 <alltraps>
...
80106118:	6a 63                	push   $0x63
  jmp alltraps
8010611a:	e9 d4 f7 ff ff       	jmp    801058f3 <alltraps>
...
80106121:	6a 64                	push   $0x64
  jmp alltraps
80106123:	e9 cb f7 ff ff       	jmp    801058f3 <alltraps>
...
8010612a:	6a 65                	push   $0x65
  jmp alltraps
8010612c:	e9 c2 f7 ff ff       	jmp    801058f3 <alltraps>
...
80106133:	6a 66                	push   $0x66
  jmp alltraps
80106135:	e9 b9 f7 ff ff       	jmp    801058f3 <alltraps>
...
8010613c:	6a 67                	push   $0x67
  jmp alltraps
8010613e:	e9 b0 f7 ff ff       	jmp    801058f3 <alltraps>
...
80106145:	6a 68                	push   $0x68
  jmp alltraps
80106147:	e9 a7 f7 ff ff       	jmp    801058f3 <alltraps>
...
8010614e:	6a 69                	push   $0x69
  jmp alltraps
80106150:	e9 9e f7 ff ff       	jmp    801058f3 <alltraps>
...
80106157:	6a 6a                	push   $0x6a
  jmp alltraps
80106159:	e9 95 f7 ff ff       	jmp    801058f3 <alltraps>
...
80106160:	6a 6b                	push   $0x6b
  jmp alltraps
80106162:	e9 8c f7 ff ff       	jmp    801058f3 <alltraps>
...
80106169:	6a 6c                	push   $0x6c
  jmp alltraps
8010616b:	e9 83 f7 ff ff       	jmp    801058f3 <alltraps>
...
80106172:	6a 6d                	push   $0x6d
  jmp alltraps
80106174:	e9 7a f7 ff ff       	jmp    801058f3 <alltraps>
...
8010617b:	6a 6e                	push   $0x6e
  jmp alltraps
8010617d:	e9 71 f7 ff ff       	jmp    801058f3 <alltraps>
...
80106184:	6a 6f                	push   $0x6f
  jmp alltraps
80106186:	e9 68 f7 ff ff       	jmp    801058f3 <alltraps>
...
8010618d:	6a 70                	push   $0x70
  jmp alltraps
8010618f:	e9 5f f7 ff ff       	jmp    801058f3 <alltraps>
...
80106196:	6a 71                	push   $0x71
  jmp alltraps
80106198:	e9 56 f7 ff ff       	jmp    801058f3 <alltraps>
...
8010619f:	6a 72                	push   $0x72
  jmp alltraps
801061a1:	e9 4d f7 ff ff       	jmp    801058f3 <alltraps>
...
801061a8:	6a 73                	push   $0x73
  jmp alltraps
801061aa:	e9 44 f7 ff ff       	jmp    801058f3 <alltraps>
...
801061b1:	6a 74                	push   $0x74
  jmp alltraps
801061b3:	e9 3b f7 ff ff       	jmp    801058f3 <alltraps>
...
801061ba:	6a 75                	push   $0x75
  jmp alltraps
801061bc:	e9 32 f7 ff ff       	jmp    801058f3 <alltraps>
...
801061c3:	6a 76                	push   $0x76
  jmp alltraps
801061c5:	e9 29 f7 ff ff       	jmp    801058f3 <alltraps>
...
801061cc:	6a 77                	push   $0x77
  jmp alltraps
801061ce:	e9 20 f7 ff ff       	jmp    801058f3 <alltraps>
...
801061d5:	6a 78                	push   $0x78
  jmp alltraps
801061d7:	e9 17 f7 ff ff       	jmp    801058f3 <alltraps>
...
801061de:	6a 79                	push   $0x79
  jmp alltraps
801061e0:	e9 0e f7 ff ff       	jmp    801058f3 <alltraps>
...
801061e7:	6a 7a                	push   $0x7a
  jmp alltraps
801061e9:	e9 05 f7 ff ff       	jmp    801058f3 <alltraps>
...
801061f0:	6a 7b                	push   $0x7b
  jmp alltraps
801061f2:	e9 fc f6 ff ff       	jmp    801058f3 <alltraps>
...
801061f9:	6a 7c                	push   $0x7c
  jmp alltraps
801061fb:	e9 f3 f6 ff ff       	jmp    801058f3 <alltraps>
...
80106202:	6a 7d                	push   $0x7d
  jmp alltraps
80106204:	e9 ea f6 ff ff       	jmp    801058f3 <alltraps>
...
8010620b:	6a 7e                	push   $0x7e
  jmp alltraps
8010620d:	e9 e1 f6 ff ff       	jmp    801058f3 <alltraps>
...
80106214:	6a 7f                	push   $0x7f
  jmp alltraps
80106216:	e9 d8 f6 ff ff       	jmp    801058f3 <alltraps>
...
8010621d:	68 80 00 00 00       	push   $0x80
  jmp alltraps
80106222:	e9 cc f6 ff ff       	jmp    801058f3 <alltraps>
...
80106229:	68 81 00 00 00       	push   $0x81
  jmp alltraps
8010622e:	e9 c0 f6 ff ff       	jmp    801058f3 <alltraps>
...
80106235:	68 82 00 00 00       	push   $0x82
  jmp alltraps
8010623a:	e9 b4 f6 ff ff       	jmp    801058f3 <alltraps>
...
80106241:	68 83 00 00 00       	push   $0x83
  jmp alltraps
80106246:	e9 a8 f6 ff ff       	jmp    801058f3 <alltraps>
...
8010624d:	68 84 00 00 00       	push   $0x84
  jmp alltraps
80106252:	e9 9c f6 ff ff       	jmp    801058f3 <alltraps>
...
80106259:	68 85 00 00 00       	push   $0x85
  jmp alltraps
8010625e:	e9 90 f6 ff ff       	jmp    801058f3 <alltraps>
...
80106265:	68 86 00 00 00       	push   $0x86
  jmp alltraps
8010626a:	e9 84 f6 ff ff       	jmp    801058f3 <alltraps>
...
80106271:	68 87 00 00 00       	push   $0x87
  jmp alltraps
80106276:	e9 78 f6 ff ff       	jmp    801058f3 <alltraps>
...
8010627d:	68 88 00 00 00       	push   $0x88
  jmp alltraps
80106282:	e9 6c f6 ff ff       	jmp    801058f3 <alltraps>
...
80106289:	68 89 00 00 00       	push   $0x89
  jmp alltraps
8010628e:	e9 60 f6 ff ff       	jmp    801058f3 <alltraps>
...
80106295:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
8010629a:	e9 54 f6 ff ff       	jmp    801058f3 <alltraps>
...
801062a1:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
801062a6:	e9 48 f6 ff ff       	jmp    801058f3 <alltraps>
...
801062ad:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
801062b2:	e9 3c f6 ff ff       	jmp    801058f3 <alltraps>
...
801062b9:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
801062be:	e9 30 f6 ff ff       	jmp    801058f3 <alltraps>
...
801062c5:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
801062ca:	e9 24 f6 ff ff       	jmp    801058f3 <alltraps>
...
801062d1:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
801062d6:	e9 18 f6 ff ff       	jmp    801058f3 <alltraps>
...
801062dd:	68 90 00 00 00       	push   $0x90
  jmp alltraps
801062e2:	e9 0c f6 ff ff       	jmp    801058f3 <alltraps>
...
801062e9:	68 91 00 00 00       	push   $0x91
  jmp alltraps
801062ee:	e9 00 f6 ff ff       	jmp    801058f3 <alltraps>
...
801062f5:	68 92 00 00 00       	push   $0x92
  jmp alltraps
801062fa:	e9 f4 f5 ff ff       	jmp    801058f3 <alltraps>
...
80106301:	68 93 00 00 00       	push   $0x93
  jmp alltraps
80106306:	e9 e8 f5 ff ff       	jmp    801058f3 <alltraps>
...
8010630d:	68 94 00 00 00       	push   $0x94
  jmp alltraps
80106312:	e9 dc f5 ff ff       	jmp    801058f3 <alltraps>
...
80106319:	68 95 00 00 00       	push   $0x95
  jmp alltraps
8010631e:	e9 d0 f5 ff ff       	jmp    801058f3 <alltraps>
...
80106325:	68 96 00 00 00       	push   $0x96
  jmp alltraps
8010632a:	e9 c4 f5 ff ff       	jmp    801058f3 <alltraps>
...
80106331:	68 97 00 00 00       	push   $0x97
  jmp alltraps
80106336:	e9 b8 f5 ff ff       	jmp    801058f3 <alltraps>
...
8010633d:	68 98 00 00 00       	push   $0x98
  jmp alltraps
80106342:	e9 ac f5 ff ff       	jmp    801058f3 <alltraps>
...
80106349:	68 99 00 00 00       	push   $0x99
  jmp alltraps
8010634e:	e9 a0 f5 ff ff       	jmp    801058f3 <alltraps>
...
80106355:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
8010635a:	e9 94 f5 ff ff       	jmp    801058f3 <alltraps>
...
80106361:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
80106366:	e9 88 f5 ff ff       	jmp    801058f3 <alltraps>
...
8010636d:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
80106372:	e9 7c f5 ff ff       	jmp    801058f3 <alltraps>
...
80106379:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
8010637e:	e9 70 f5 ff ff       	jmp    801058f3 <alltraps>
...
80106385:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
8010638a:	e9 64 f5 ff ff       	jmp    801058f3 <alltraps>
...
80106391:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
80106396:	e9 58 f5 ff ff       	jmp    801058f3 <alltraps>
...
8010639d:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
801063a2:	e9 4c f5 ff ff       	jmp    801058f3 <alltraps>
...
801063a9:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
801063ae:	e9 40 f5 ff ff       	jmp    801058f3 <alltraps>
...
801063b5:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
801063ba:	e9 34 f5 ff ff       	jmp    801058f3 <alltraps>
...
801063c1:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
801063c6:	e9 28 f5 ff ff       	jmp    801058f3 <alltraps>
...
801063cd:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
801063d2:	e9 1c f5 ff ff       	jmp    801058f3 <alltraps>
...
801063d9:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
801063de:	e9 10 f5 ff ff       	jmp    801058f3 <alltraps>
...
801063e5:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
801063ea:	e9 04 f5 ff ff       	jmp    801058f3 <alltraps>
...
801063f1:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
801063f6:	e9 f8 f4 ff ff       	jmp    801058f3 <alltraps>
...
801063fd:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
80106402:	e9 ec f4 ff ff       	jmp    801058f3 <alltraps>
...
80106409:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
8010640e:	e9 e0 f4 ff ff       	jmp    801058f3 <alltraps>
...
80106415:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
8010641a:	e9 d4 f4 ff ff       	jmp    801058f3 <alltraps>
...
80106421:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
80106426:	e9 c8 f4 ff ff       	jmp    801058f3 <alltraps>
...
8010642d:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
80106432:	e9 bc f4 ff ff       	jmp    801058f3 <alltraps>
...
80106439:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
8010643e:	e9 b0 f4 ff ff       	jmp    801058f3 <alltraps>
...
80106445:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
8010644a:	e9 a4 f4 ff ff       	jmp    801058f3 <alltraps>
...
80106451:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
80106456:	e9 98 f4 ff ff       	jmp    801058f3 <alltraps>
...
8010645d:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
80106462:	e9 8c f4 ff ff       	jmp    801058f3 <alltraps>
...
80106469:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
8010646e:	e9 80 f4 ff ff       	jmp    801058f3 <alltraps>
...
80106475:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
8010647a:	e9 74 f4 ff ff       	jmp    801058f3 <alltraps>
...
80106481:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
80106486:	e9 68 f4 ff ff       	jmp    801058f3 <alltraps>
...
8010648d:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
80106492:	e9 5c f4 ff ff       	jmp    801058f3 <alltraps>
...
80106499:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
8010649e:	e9 50 f4 ff ff       	jmp    801058f3 <alltraps>
...
801064a5:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
801064aa:	e9 44 f4 ff ff       	jmp    801058f3 <alltraps>
...
801064b1:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
801064b6:	e9 38 f4 ff ff       	jmp    801058f3 <alltraps>
...
801064bd:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
801064c2:	e9 2c f4 ff ff       	jmp    801058f3 <alltraps>
...
801064c9:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
801064ce:	e9 20 f4 ff ff       	jmp    801058f3 <alltraps>
...
801064d5:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
801064da:	e9 14 f4 ff ff       	jmp    801058f3 <alltraps>
...
801064e1:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
801064e6:	e9 08 f4 ff ff       	jmp    801058f3 <alltraps>
...
801064ed:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
801064f2:	e9 fc f3 ff ff       	jmp    801058f3 <alltraps>
...
801064f9:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
801064fe:	e9 f0 f3 ff ff       	jmp    801058f3 <alltraps>
...
80106505:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
8010650a:	e9 e4 f3 ff ff       	jmp    801058f3 <alltraps>
...
80106511:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
80106516:	e9 d8 f3 ff ff       	jmp    801058f3 <alltraps>
...
8010651d:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
80106522:	e9 cc f3 ff ff       	jmp    801058f3 <alltraps>
...
80106529:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
8010652e:	e9 c0 f3 ff ff       	jmp    801058f3 <alltraps>
...
80106535:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
8010653a:	e9 b4 f3 ff ff       	jmp    801058f3 <alltraps>
...
80106541:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
80106546:	e9 a8 f3 ff ff       	jmp    801058f3 <alltraps>
...
8010654d:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
80106552:	e9 9c f3 ff ff       	jmp    801058f3 <alltraps>
...
80106559:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
8010655e:	e9 90 f3 ff ff       	jmp    801058f3 <alltraps>
...
80106565:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
8010656a:	e9 84 f3 ff ff       	jmp    801058f3 <alltraps>
...
80106571:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
80106576:	e9 78 f3 ff ff       	jmp    801058f3 <alltraps>
...
8010657d:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
80106582:	e9 6c f3 ff ff       	jmp    801058f3 <alltraps>
...
80106589:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
8010658e:	e9 60 f3 ff ff       	jmp    801058f3 <alltraps>
...
80106595:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
8010659a:	e9 54 f3 ff ff       	jmp    801058f3 <alltraps>
...
801065a1:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
801065a6:	e9 48 f3 ff ff       	jmp    801058f3 <alltraps>
...
801065ad:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
801065b2:	e9 3c f3 ff ff       	jmp    801058f3 <alltraps>
...
801065b9:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
801065be:	e9 30 f3 ff ff       	jmp    801058f3 <alltraps>
...
801065c5:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
801065ca:	e9 24 f3 ff ff       	jmp    801058f3 <alltraps>
...
801065d1:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
801065d6:	e9 18 f3 ff ff       	jmp    801058f3 <alltraps>
...
801065dd:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
801065e2:	e9 0c f3 ff ff       	jmp    801058f3 <alltraps>
...
801065e9:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
801065ee:	e9 00 f3 ff ff       	jmp    801058f3 <alltraps>
...
801065f5:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
801065fa:	e9 f4 f2 ff ff       	jmp    801058f3 <alltraps>
...
80106601:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
80106606:	e9 e8 f2 ff ff       	jmp    801058f3 <alltraps>
...
8010660d:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
80106612:	e9 dc f2 ff ff       	jmp    801058f3 <alltraps>
...
80106619:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
8010661e:	e9 d0 f2 ff ff       	jmp    801058f3 <alltraps>
...
80106625:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
8010662a:	e9 c4 f2 ff ff       	jmp    801058f3 <alltraps>
...
80106631:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
80106636:	e9 b8 f2 ff ff       	jmp    801058f3 <alltraps>
...
8010663d:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
80106642:	e9 ac f2 ff ff       	jmp    801058f3 <alltraps>
...
80106649:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
8010664e:	e9 a0 f2 ff ff       	jmp    801058f3 <alltraps>
...
80106655:	68 da 00 00 00       	push   $0xda
  jmp alltraps
8010665a:	e9 94 f2 ff ff       	jmp    801058f3 <alltraps>
...
80106661:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
80106666:	e9 88 f2 ff ff       	jmp    801058f3 <alltraps>
...
8010666d:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
80106672:	e9 7c f2 ff ff       	jmp    801058f3 <alltraps>
...
80106679:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
8010667e:	e9 70 f2 ff ff       	jmp    801058f3 <alltraps>
...
80106685:	68 de 00 00 00       	push   $0xde
  jmp alltraps
8010668a:	e9 64 f2 ff ff       	jmp    801058f3 <alltraps>
...
80106691:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
80106696:	e9 58 f2 ff ff       	jmp    801058f3 <alltraps>
...
8010669d:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
801066a2:	e9 4c f2 ff ff       	jmp    801058f3 <alltraps>
...
801066a9:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
801066ae:	e9 40 f2 ff ff       	jmp    801058f3 <alltraps>
...
801066b5:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
801066ba:	e9 34 f2 ff ff       	jmp    801058f3 <alltraps>
...
801066c1:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
801066c6:	e9 28 f2 ff ff       	jmp    801058f3 <alltraps>
...
801066cd:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
801066d2:	e9 1c f2 ff ff       	jmp    801058f3 <alltraps>
...
801066d9:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
801066de:	e9 10 f2 ff ff       	jmp    801058f3 <alltraps>
...
801066e5:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
801066ea:	e9 04 f2 ff ff       	jmp    801058f3 <alltraps>
...
801066f1:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
801066f6:	e9 f8 f1 ff ff       	jmp    801058f3 <alltraps>
...
801066fd:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
80106702:	e9 ec f1 ff ff       	jmp    801058f3 <alltraps>
...
80106709:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
8010670e:	e9 e0 f1 ff ff       	jmp    801058f3 <alltraps>
...
80106715:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
8010671a:	e9 d4 f1 ff ff       	jmp    801058f3 <alltraps>
...
80106721:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
80106726:	e9 c8 f1 ff ff       	jmp    801058f3 <alltraps>
...
8010672d:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
80106732:	e9 bc f1 ff ff       	jmp    801058f3 <alltraps>
...
80106739:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
8010673e:	e9 b0 f1 ff ff       	jmp    801058f3 <alltraps>
...
80106745:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
8010674a:	e9 a4 f1 ff ff       	jmp    801058f3 <alltraps>
...
80106751:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
80106756:	e9 98 f1 ff ff       	jmp    801058f3 <alltraps>
...
8010675d:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
80106762:	e9 8c f1 ff ff       	jmp    801058f3 <alltraps>
...
80106769:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
8010676e:	e9 80 f1 ff ff       	jmp    801058f3 <alltraps>
...
80106775:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
8010677a:	e9 74 f1 ff ff       	jmp    801058f3 <alltraps>
...
80106781:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
80106786:	e9 68 f1 ff ff       	jmp    801058f3 <alltraps>
...
8010678d:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
80106792:	e9 5c f1 ff ff       	jmp    801058f3 <alltraps>
...
80106799:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
8010679e:	e9 50 f1 ff ff       	jmp    801058f3 <alltraps>
...
801067a5:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
801067aa:	e9 44 f1 ff ff       	jmp    801058f3 <alltraps>
...
801067b1:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
801067b6:	e9 38 f1 ff ff       	jmp    801058f3 <alltraps>
...
801067bd:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
801067c2:	e9 2c f1 ff ff       	jmp    801058f3 <alltraps>
...
801067c9:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
801067ce:	e9 20 f1 ff ff       	jmp    801058f3 <alltraps>
...
801067d5:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
801067da:	e9 14 f1 ff ff       	jmp    801058f3 <alltraps>
...
801067e1:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
801067e6:	e9 08 f1 ff ff       	jmp    801058f3 <alltraps>
...
801067ed:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
801067f2:	e9 fc f0 ff ff       	jmp    801058f3 <alltraps>
...
801067f9:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
801067fe:	e9 f0 f0 ff ff       	jmp    801058f3 <alltraps>
...
80106805:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
8010680a:	e9 e4 f0 ff ff       	jmp    801058f3 <alltraps>
...
80106811:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
80106816:	e9 d8 f0 ff ff       	jmp    801058f3 <alltraps>
...
8010687a:	e8 51 de ff ff       	call   801046d0 <memset>
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
...
8010691d:	68 0c 7a 10 80       	push   $0x80107a0c
...
801069e7:	83 ec 18             	sub    $0x18,%esp
  c = &cpus[cpuid()];
801069ea:	e8 61 cf ff ff       	call   80103950 <cpuid>
  pd[0] = size-1;
...
801069fe:	c7 80 f8 27 11 80 ff 	movl   $0xffff,-0x7feed808(%eax)
80106a05:	ff 00 00 
80106a08:	c7 80 fc 27 11 80 00 	movl   $0xcf9a00,-0x7feed804(%eax)
80106a0f:	9a cf 00 
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
80106a12:	c7 80 00 28 11 80 ff 	movl   $0xffff,-0x7feed800(%eax)
80106a19:	ff 00 00 
80106a1c:	c7 80 04 28 11 80 00 	movl   $0xcf9200,-0x7feed7fc(%eax)
80106a23:	92 cf 00 
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
80106a26:	c7 80 08 28 11 80 ff 	movl   $0xffff,-0x7feed7f8(%eax)
80106a2d:	ff 00 00 
80106a30:	c7 80 0c 28 11 80 00 	movl   $0xcffa00,-0x7feed7f4(%eax)
80106a37:	fa cf 00 
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
80106a3a:	c7 80 10 28 11 80 ff 	movl   $0xffff,-0x7feed7f0(%eax)
80106a41:	ff 00 00 
80106a44:	c7 80 14 28 11 80 00 	movl   $0xcff200,-0x7feed7ec(%eax)
80106a4b:	f2 cf 00 
  lgdt(c->gdt, sizeof(c->gdt));
80106a4e:	05 f0 27 11 80       	add    $0x801127f0,%eax
  pd[1] = (uint)p;
...
80106a74:	a1 a4 74 11 80       	mov    0x801174a4,%eax
...
80106ab8:	0f 84 c2 00 00 00    	je     80106b80 <switchuvm+0xf0>
  pushcli();
80106abe:	e8 fd d9 ff ff       	call   801044c0 <pushcli>
...
80106bd3:	e8 f8 da ff ff       	call   801046d0 <memset>
...
80106c06:	5d                   	pop    %ebp
  memmove(mem, init, sz);
80106c07:	e9 64 db ff ff       	jmp    80104770 <memmove>
    panic("inituvm: more than a page");
80106c0c:	83 ec 0c             	sub    $0xc,%esp
80106c0f:	68 51 7a 10 80       	push   $0x80107a51
...
80106d79:	68 89 7a 10 80       	push   $0x80107a89
...
80106ddb:	68 a1 7a 10 80       	push   $0x80107aa1
...
80106ebc:	68 bd 7a 10 80       	push   $0x80107abd
...
80106ee7:	bb 20 a4 10 80       	mov    $0x8010a420,%ebx
  memset(pgdir, 0, PGSIZE);
80106eec:	68 00 10 00 00       	push   $0x1000
80106ef1:	6a 00                	push   $0x0
80106ef3:	50                   	push   %eax
80106ef4:	e8 d7 d7 ff ff       	call   801046d0 <memset>
...
80106f1e:	81 fb 60 a4 10 80    	cmp    $0x8010a460,%ebx
...
80106f5f:	a3 a4 74 11 80       	mov    %eax,0x801174a4
  lcr3(V2P(kpgdir));   // switch to the kernel page table
...
80106f93:	68 ce 7a 10 80       	push   $0x80107ace
...
80106fe0:	e8 8b d7 ff ff       	call   80104770 <memmove>
...
80107079:	68 f2 7a 10 80       	push   $0x80107af2
8010707e:	e8 0d 93 ff ff       	call   80100390 <panic>
      panic("copyuvm: pte should exist");
80107083:	83 ec 0c             	sub    $0xc,%esp
80107086:	68 d8 7a 10 80       	push   $0x80107ad8
...
8010710e:	e8 5d d6 ff ff       	call   80104770 <memmove>
    len -= n;
    buf += n;
